    ...
    def enrich_topo_origins(self, primitives: list[dict[str, Any]]) -> list[dict[str, Any]]:
        ...
        for prim in primitives:
            if 'topo_origins' in prim:
                new_origins = set(prim['topo_origins'])
                for origin in prim['topo_origins']:
                    if origin in self.edge_to_faces:
                        new_origins.update(self.edge_to_faces[origin])
                prim['topo_origins'] = list(new_origins)
