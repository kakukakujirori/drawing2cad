...
class InputManifest:
    ...
    offered alongside the drawing is a sheet like any other.
    """
...
class FeedbackManifest:
    ...
    keyed by the name the sheet would have been announced under, because a
    sheet that was never produced cannot carry its own explanation.
    """
    ...
    def __post_init__(self) -> None:
        ...
        if self.drawing is not None:
            ...
            drawn = {sheet.name for sheet in self.drawing.sheets}
