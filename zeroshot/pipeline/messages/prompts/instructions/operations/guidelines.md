...
- Revise an existing entry to answer feedback about the operation it performs, keeping its name so that references to it stay true. An entry you add takes a new name of its own; no existing identity changes or shifts.
