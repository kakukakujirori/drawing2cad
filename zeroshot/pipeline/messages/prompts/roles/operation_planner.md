...
Your objective is to convert the semantic hypothesis you are given into a high-level, ordered plan that a CAD developer can implement in CadQuery without guessing.
