...
- For each view in the input drawing, open the projection from the same direction and compare the two using `run_shell` and `load_image`. Also inspect the perspective render.
